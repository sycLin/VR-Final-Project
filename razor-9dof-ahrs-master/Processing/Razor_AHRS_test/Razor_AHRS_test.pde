...
OscP5 oscP5;
int oscp5Port = 12000;
String oscpIP = "127.0.0.1";
int oscp5TargetPort = 5567;
...
void setup() {
  ...
  oscP5 = new OscP5(this,oscpIP,oscp5TargetPort, OscP5.TCP);
  //myRemoteLocation = new NetAddress(oscpIP,oscp5TargetPort);
...
void draw() {
  ...
  oscP5.send("", new Object[] {"\t{\"command\":\"IMU1\",\"yaw\":"+(yaw-yawOffset)+",\"pitch\":"+pitch+",\"roll\":"+roll+"}\n"});
